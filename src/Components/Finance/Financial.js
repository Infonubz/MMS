...
export default function Financial() {
  ...
  return (
    <div className="h-full w-full">
        ...
        <div className="flex flex-row bg-[#F9F9F9] mt-[0.5vh] h-[6vh] rounded-[1vw] justify-between p-[0.8vh]">
          <div className="flex">
        ...
        <div className="flex-1 h-[70vh]">
          {tabName === "Payables" ? (
            <div>
              <Payables currentItems={currentItems} />
            </div>
          ) : (
            <div>
              <Receivables currentItems={currentItems} />
            </div>
          )}
        </div>
        <div className="flex mt-[5.9vh] h-[10vh] bg-[#f9f9f900] justify-between items-center">
