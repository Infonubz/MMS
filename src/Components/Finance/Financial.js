...
export default function Financial() {
  ...
  const [tabName, setTabName] = useState("Payables");
  ...
  const dataSource = [
    {
      key: 1,
      id: 25561,
      name: "Edward King Isabella George",
    ...
    <div className="">
      <div className="flex flex-row gap-[2vw] h-[4vh] justify-between">
        <div className="flex flex-row">
          <h1 className="text-[1.5vw] font-semibold">FINANCE MANAGEMENT</h1>
        ...
        >
          <h1 className="text-[1.2vw]" onClick={() => setTabName("Payables")}>
            Payables
          </h1>
        </div>
        <div
        ...
        >
          <h1
            ...
            onClick={() => setTabName("Receivables")}
          >
            Receivables
          </h1>
        </div>
      ...
      <div className="flex flex-row bg-[#F9F9F9] mt-[0.9vh] h-[6vh] rounded-[1vw] justify-between p-[0.8vh]">
        <div className="flex">
      ...
      <div className="flex-1 h-[68vh]">
        {tabName === "Payables" ? (
          <div>
            <Payables setIsModalPopup={setIsModalPopup} setRowCount={setRowCount} currentItems={currentItems} />
          </div>
        ) : (
          <div>
            <Receivables setIsModalPopup={setIsModalPopup} setRowCount={setRowCount} currentItems={currentItems} />
          </div>
        )}
      </div>
      <div className="flex mt-[9.7vh] bg-[#f9f9f900] justify-between items-center">
        ...
        <div className="flex flex-row gap-[0.5vw] bg-[#f9f9f900] items-center pr-[0.5vw]">
          ...
          <button
            className="bg-[#3348FF] text-[0.8vw] font-bold text-white border border-[#3348FF] shadow-md shadow-[#d8d6d6] flex px-[0.3vw] h-[1.5vw] justify-center items-center rounded-[1vw]"
