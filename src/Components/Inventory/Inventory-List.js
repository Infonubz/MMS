...
export default function InventoryList({ currentItems }) {
  ...
  const columns = [
    ...
    {
      title: <span className="text-[0.95vw] font-normal">Available Stock</span>,
      dataIndex: "available",
      align: "center",
      sorter: (a, b) => a.available?.localeCompare(b.available),
      render: (available) => <span className="text-[0.85vw]">{available}</span>,
    },
    {
      title: <span className="text-[0.95vw] font-normal">Received Stock</span>,
      dataIndex: "received",
      align: "center",
    ...
    {
      title: <span className="text-[0.95vw] font-normal">Last Updated</span>,
    ...
    {
      title: <span className="text-[0.95vw] font-normal">Stock Status</span>,
