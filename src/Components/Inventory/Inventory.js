  ...
  const dataSource = [
    {
      ...
      poNumber: "0560/24",
      styleId: "#23454GH6J",
      styleName: "Wrap around dress",
      available: "500",
      received: "1000",
      lastupdated: "3rd Dec 2024",
    ...
    <div className="">
      <div className="flex flex-row gap-[2vw] h-[4vh] justify-between">
        <div className="flex flex-row">
          <h1 className="text-[1.5vw] font-semibold">INVENTORY MANAGEMENT</h1>
        </div>
        <div className="flex gap-[2vw] justify-end ml-auto">
          ...
          <div>
            <div>
              ...
              />
              <button
                className="bg-[#ffffff] border border-[#ebebeb] shadow-md shadow-[#d8d6d6] flex px-[0.75vw] h-[1.8vw] justify-center gap-[0.5vw] 
          ...
          <div>
            <div>
              ...
              />
              <button
                className="bg-[#ffffff] border border-[#ebebeb] shadow-md shadow-[#d8d6d6] flex px-[0.75vw] h-[1.8vw] justify-center 
      ...
      <div className="flex-1 h-[68vh]">
        <InventoryList currentItems={currentItems} />
      </div>
