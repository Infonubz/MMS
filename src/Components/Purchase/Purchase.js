...
export default function Purchase() {
  ...
  const dataSource = [
    ...
    },
    {
      ...
      poNumber: "0560/24",
      styleId: "#23454GH6J",
      styleName: "Smoked/layered dress",
      supplier: "Sri Bhagya Lakshmi Garments",
      issueDate: "3rd Dec 2024",
      purchaseStatus: "Pending",
    },
    ...
    <div className="">
      ...
      <div className="flex mt-[10vh] bg-[#f9f9f900] justify-between items-center">
        ...
        <div className="flex flex-row gap-[0.5vw] bg-[#f9f9f900] items-center pr-[0.5vw]">
          ...
          <button
            className="bg-[#3348FF] text-[0.8vw] text-white border border-[#3348FF] font-bold shadow-md shadow-[#d8d6d6] flex px-[0.3vw] h-[1.5vw] justify-center items-center rounded-[1vw]"
