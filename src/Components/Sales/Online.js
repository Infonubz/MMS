...
export default function Online({ setIsModalPopup, setRowCount, currentItems }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (lastupdated) => (
        <div className="flex flex-row gap-2 pl-[2vw]">
          <span className="h-[0.5vw] w-[0.85vw] rounded-[0.5vw] mt-[0.45vw] bg-[#323232]"></span>
          <span className="h-[0.5vw] w-[0.85vw] rounded-[0.5vw] mt-[0.45vw] bg-[#E98F8F]"></span>
          <span className="h-[0.5vw] w-[0.85vw] rounded-[0.5vw] mt-[0.45vw] bg-[#A22F2F]"></span>
      ...
      <div className="mt-[0.4vw]">
        ...
        >
          <Table
            ...
            style={{
              height: "68vh", // Ensure table height is restricted
              width:"100%"
            }}
            columns={columns}
            pagination={false}
