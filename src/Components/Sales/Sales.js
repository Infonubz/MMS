...
export default function Sales() {
  ...
  const [tabName, setTabName] = useState("Online");
    ...
    <div className="">
      <div className="flex flex-row gap-[2vw] h-[4vh] justify-between">
        <div className="flex flex-row">
          <h1 className="text-[1.5vw] font-semibold">SALES MANAGEMENT</h1>
        ...
        >
          <h1 className="text-[1.2vw]" onClick={() => setTabName("Online")}>
            Online
          </h1>
        </div>
        <div
        ...
        >
          <h1 className="text-[1.2vw]" onClick={() => setTabName("Offline")}>
            Offline
          </h1>
        </div>
      ...
      <div className="flex flex-row bg-[#F9F9F9] rounded-[1vw] mt-[0.9vh] justify-between p-[0.4vw]">
        <div className="flex">
      ...
      <div className="flex-1 h-[68vh]">
        {tabName === "Online" ? (
          <div>
            <Online setIsModalPopup={setIsModalPopup} setRowCount={setRowCount} currentItems={currentItems} />
          </div>
        ) : (
          <div>
            <Offline setIsModalPopup={setIsModalPopup} setRowCount={setRowCount} currentItems={currentItems} />
          </div>
        )}
      </div>
      <div className="flex mt-[10vh] bg-[#f9f9f900] justify-between items-center">
